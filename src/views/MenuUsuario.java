...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		// botao voltar usuario
		
		JPanel btnVoltar = new JPanel();
		btnVoltar.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnVoltar.setBackground(new Color(118, 187, 223));				
			}
			@Override
			public void mouseExited(MouseEvent e) {
		...
		btnVoltar.setBounds(0, 370, 257, 56);// local mudar
		btnVoltar.setBackground(new Color(12, 138, 199));
		btnVoltar.setLayout(null);
		btnVoltar.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
		panelMenu.add(btnVoltar);
		
		JLabel sairMenuUsuario = new JLabel("      Sair");
		//caso queira por uma imagem
		//sairMenuUsuario.setIcon(new ImageIcon(MenuUsuario.class.getResource("/imagenes/pessoas.png")));
		sairMenuUsuario.setBounds(30, 11, 200, 34);
		sairMenuUsuario.setHorizontalAlignment(SwingConstants.LEFT);
		sairMenuUsuario.setForeground(Color.WHITE);
		sairMenuUsuario.setFont(new Font("Roboto", Font.PLAIN, 18));
		btnVoltar.add(sairMenuUsuario);
		//fim do botao
