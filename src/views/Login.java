...
public class Login extends JFrame {
	...
	public Login() {
		...
		btnLogin2.addMouseListener(new MouseAdapter() {
			@Override
			public void mouseEntered(MouseEvent e) {
				btnLogin2.setBackground(new Color(0, 156, 223));
			}
		
			@Override
			public void mouseExited(MouseEvent e) {
				btnLogin2.setBackground(SystemColor.textHighlight);
			}
			@Override
			public void mouseClicked(MouseEvent e) {
				criarLogin();
		...
		btnLogin2.setBackground(SystemColor.textHighlight);
		btnLogin2.setBounds(250, 431, 122, 44);
		panel.add(btnLogin2);
		btnLogin2.setLayout(null);
		btnLogin2.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
		
		JLabel lblEntrar2 = new JLabel("Novo Login");
		lblEntrar2.setBounds(0, 0, 122, 44);
		btnLogin2.add(lblEntrar2);
		lblEntrar2.setForeground(SystemColor.controlLtHighlight);
		lblEntrar2.setHorizontalAlignment(SwingConstants.CENTER);
		lblEntrar2.setFont(new Font("Roboto", Font.PLAIN, 18));
		
		JLabel logo2 = new JLabel("");
		logo2.setHorizontalAlignment(SwingConstants.CENTER);
		logo2.setIcon(new ImageIcon(Login.class.getResource("/imagenes/lOGO-50PX.png")));
		logo2.setBounds(65, 65, 48, 59);
		panel.add(logo2);
		...
		header2.setBackground(SystemColor.window);
	...
	private void criarLogin () {
		CriarLogin novoUsuario = new CriarLogin();
	...
	private boolean Login() throws SQLException {
		...
		try(Connection abreConexao = new ConnectionFactory().recuperarConexao()){
			...
			for(LoginUsuario loginValido : listaDelogin) {
				String senhaa =new String (txtSenha.getPassword());
				
				 if(loginValido.getUsuario().equals(txtUsuario.getText())  && loginValido.getSenha().equals(senhaa)){	
		        	return true;
		        }
			} 
			return false;
