...
public class ReservasView extends JFrame {
	...
	public void salvarReserva() {
		try {
			...
			Reservas reservaConstrutor = new Reservas( dataEntrada, dataSaida, ReservasView . txtValor . getText () , ReservasView . txtFormaPagamento . getSelectedItem (). toString ());
			this.reservasControl.salvarControoller(reservaConstrutor);
			JOptionPane.showMessageDialog(this, "Salvo com sucesso!");
			RegistroHospede registro = new RegistroHospede(reservaConstrutor.getId());
