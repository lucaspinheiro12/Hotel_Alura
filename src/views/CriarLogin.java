...
public class CriarLogin extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					CriarLogin frame = new CriarLogin();
	...
	public CriarLogin() {
		...
		imgHotel.setIcon(new ImageIcon(CriarLogin.class.getResource("/imagenes/img-hotel-login-.png")));
		...
		JLabel labelTitulo = new JLabel("Novo");
		labelTitulo.setForeground(SystemColor.textHighlight);
		labelTitulo.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo.setBounds(196, 140, 89, 26);
		panel.add(labelTitulo);
		
		JLabel labelTitulo2 = new JLabel("Usuario");
		labelTitulo2.setForeground(SystemColor.textHighlight);
		labelTitulo2.setFont(new Font("Roboto Black", Font.PLAIN, 26));
		labelTitulo2.setBounds(184, 160, 89, 26);
		...
		JLabel lblEntrar = new JLabel("Salvar");
		...
		logo.setIcon(new ImageIcon(CriarLogin.class.getResource("/imagenes/lOGO-50PX.png")));
	...
	private void salvarLogin() {
		try {
			String usuario = (( JTextField ) txtUsuario). getText ();
			String senha = (( JTextField ) txtSenha).getText ();
			LoginUsuario novoUsuario = new LoginUsuario(usuario, senha);
			this.loginController.salvarControoller(novoUsuario);
			JOptionPane.showMessageDialog(this, "Salvo com sucesso!");
			dispose();
		}catch (Exception e) {
			JOptionPane.showMessageDialog(contentPane, "Error2: " + e.getMessage(), "Erro1", JOptionPane.ERROR_MESSAGE);
		}
	}
